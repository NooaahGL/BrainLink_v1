...
class SaveDataWindow:
    ...
    def __init__(self, file_name, data):
        ...
        self.lbl_data_type = tk.Label(self.window, text="Se guardarán los datos del usuario: " + file_name)
    ...
    def DI_cargar_archivo(self):
        ...
        if self.data:
            ...
            ruta_completa = os.path.join(self.folder_path, self.file_name)

            file_name = self.file_name+".csv"
            save_data(self.folder_path, file_name, self.data)
